...
```bash
git clone https://github.com/R00tedbrain/StopChatControL.git
cd StopChatControL
...
- 📋 **Issues**: [GitHub Issues](https://github.com/R00tedbrain/StopChatControL/issues)
- 📖 **Documentación**: [Wiki](https://github.com/R00tedbrain/StopChatControL/wiki)
- 💬 **Soporte**: [Discussions](https://github.com/R00tedbrain/StopChatControL/discussions)
